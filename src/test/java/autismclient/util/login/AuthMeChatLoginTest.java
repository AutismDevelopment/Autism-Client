...
class AuthMeChatLoginTest {
    ...
    @Test
    void loginCommandForFollowsTheServersAbbreviation() {

        assertEquals("/log", AuthMeChatLogin.loginCommandFor("/reg", ""));
        assertEquals("/login", AuthMeChatLogin.loginCommandFor("/register", ""));
        assertEquals("/login", AuthMeChatLogin.loginCommandFor("", null));

        assertEquals("/login", AuthMeChatLogin.loginCommandFor("/reg", "/login"));
    }
}
