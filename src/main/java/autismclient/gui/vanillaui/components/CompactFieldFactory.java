...
public final class CompactFieldFactory {
    ...
    public static void toggle(UiContext context, UiBounds bounds, boolean enabled, boolean hovered, String animationKey) {
        Toggle.render(context, bounds, enabled, hovered, animationKey);
    }
