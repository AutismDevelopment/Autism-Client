...
public class AutismModuleScreen extends AutismScreen {
    ...
    private void runMenuCloseCleanup() {
        ...
        AutismOverlayManager.get().restoreClampedAwayBounds();
    ...
    private void syncUtilityOverlays() {
        ...
        if (isTitleSetup()) {
            ...
            if (utilityCustomFilterOverlay.getPresetManagerOverlay() != null) {
                ...
                if (findRegisteredOverlay(autismclient.util.AutismCustomFilterPresetOverlay.class, null) == null) {
            ...
            if (macroEditor != null) {
                if (findRegisteredOverlay(autismclient.util.AutismMacroEditorOverlay.class, null) == null) {
        ...
        if (parent instanceof AbstractContainerScreen<?> handledScreen) {
            utilityFabricatorOverlay = findRegisteredOverlay(AutismFabricatorOverlay.class, null);
        ...
        utilityLanSyncOverlay = findRegisteredOverlay(AutismLANSyncOverlay.class, null);
        ...
        utilityAdminToolsOverlay = findRegisteredOverlay(AutismAdminToolsOverlay.class, null);
    ...
    private void runUtility(String id) {
        ...
        if (isTitleSetup()) {
            switch (id) {
                ...
                case "matchmaking" -> {
                    AutismModule global = AutismModule.get();
                    if (global != null) {
                        autismclient.util.IAutismOverlay mm = global.getMatchmakingOverlay();
                        if (mm != null) {
                            AutismOverlayManager.get().register(mm);
                            ((autismclient.util.AutismMatchmakingOverlay) mm).setMainMenuMode(true);
                            mm.setVisible(true);
        ...
        switch (id) {
            ...
            case "matchmaking" -> {
                autismclient.util.IAutismOverlay matchmaking = global.getMatchmakingOverlay();
                if (matchmaking != null) {
                    AutismOverlayManager.get().register(matchmaking);
                    ((autismclient.util.AutismMatchmakingOverlay) matchmaking).setMainMenuMode(false);
