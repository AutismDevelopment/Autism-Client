...
public final class AutismClientMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        autismclient.modules.HoleEspModule.initialize();
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            try {
                autismclient.modules.ScaffoldModule.endMovementTick();
            } catch (Throwable t) {
            ...
            try {
                ...
                autismclient.modules.ModuleOreSim.tickRetention();
            } catch (Throwable t) {
            ...
            try {
                ...
                if (!autismclient.util.AutismLiteVariant.enabled()
                    && autismclient.util.AutismDiscordLogin.hasSession() && autismclient.util.mm.MmPrefs.get().autoJoinPublic())
        ...
        ItemTooltipCallback.EVENT.register((stack, tooltipContext, tooltipType, lines) -> {
            ...
            AutismItemNbtSanity.scrubUnsafeTooltipLines(lines);
            AutismItemNbtSanity.trimTooltipLines(lines);
