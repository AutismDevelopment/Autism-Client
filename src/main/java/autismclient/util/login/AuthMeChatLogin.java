...
public final class AuthMeChatLogin {
    ...
    public enum Kind { NONE, REGISTER, LOGIN }

    public record Detection(Kind kind, String command, int passwordArgs) {
        public static final Detection NONE = new Detection(Kind.NONE, "", 0);
    ...
    public static Detection detect(String rawLine) {
    ...
    public static String loginCommandFor(String registerCommand, String seenLoginCommand) {
        if (seenLoginCommand != null && !seenLoginCommand.isBlank()) return seenLoginCommand;
