...
public class AutismClipboardHelper {
    ...
    public static List<MacroAction> pasteMacroStepsFromClipboard() {
        try {
            ...
            AutismClientAddon.LOG.error("[Autism] Failed to paste macro steps from clipboard", e);
            return null;
        }
    }
        ...
        try {
            ...
            try {
                ...
                if (tag.contains("friendlyName")) {
                    ...
                    packetClass = AutismPacketRegistry.getPacket(friendlyName);
                }
            }

            if (packetClass == null) {
                AutismClientAddon.LOG.error("[Autism] Could not find packet class: {}", className);
                return null;
            }
