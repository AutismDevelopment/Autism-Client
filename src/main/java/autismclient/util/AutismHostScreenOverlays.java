...
public final class AutismHostScreenOverlays {
    ...
    private AutismHostScreenOverlays(Font font) {
        ...
        AutismMultiOverlay multiOverlay = autismModule == null ? null : autismModule.getMultiOverlayIfExists();
        ...
        if (autismModule != null) {
            AutismMatchmakingOverlay matchmakingOverlay = autismModule.getMatchmakingOverlay();
            if (matchmakingOverlay != null && matchmakingOverlay.isVisible()) manager.register(matchmakingOverlay);
            AutismProfilesOverlay profilesOverlay = autismModule.getProfilesOverlay();
